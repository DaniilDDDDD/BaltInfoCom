...
<li>выполнить команду <code>java -jar BaltInfoCom.jar 
<i>download (если скачивать файл, иначе оставьте в этом параметре любую другую строку)</i>
<i>ссылка_на_файл_с_данными (если указан параметер download, иначе путь до файла с данными)</i>
<i>путь_до_файла_для_записи_ответа</i></code>
</ol>
